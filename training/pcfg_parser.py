...
from training.detectors.alphabet_detection import detect_alphabet_mask, expand_all_segmentations, detect_alphabet
...
from training.detectors.korean_detection import mark_hn_sections
