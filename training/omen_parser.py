...
from training import smoothing

@dataclass
class AlphabetGrammerNode:
    count_at_start = 0  # 시작위치에서 등장 횟수
    count_at_end = 0  # 마지막 위치에서 등장 횟수
    count_in_middle = 0  # 중간 위치에서 등장 횟수
    next_letter_candidates = {}  # 다음 알파벳 등장 가능 후보
