...
from lib_training.detectors.keyboard_walk_detection import detect_keyboard_walk
...
class PCFGParser:
    ...
    def parse(self,password):
        ...
        _, section_list = mark_hn_sections(section_list)
