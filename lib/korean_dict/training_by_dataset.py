...
from lib.korean_dict.data_parser.korean_copus_parser import KoreanCopusParser, YoutubeCommentParser
from lib.korean_dict.data_parser.name_parser import NameListParser
from lib.korean_dict.data_parser.new_word_parser import NewWordParser, NewWordParser2, NewWordParser3
from lib.korean_dict.data_parser.word_parser import TabularNounParser
from lib.korean_dict.io.save_load import load_checkpoint_counts, save_checkpoint_counts, save_checkpoint_done, \
...
def main():
    ...
    ck_counts = Path(os.path.join(config.KOREAN_PATH, "checkpoint_counts.json"))
    ck_done = Path(os.path.join(config.KOREAN_PATH, "checkpoint_done.json"))
